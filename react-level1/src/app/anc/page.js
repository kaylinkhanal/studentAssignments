...
const Chat = () => {
  ...
  const displayName = ()=>{
    let [name, setName] = useState('Chat Message')
  }
  return (
...
<div className="flex h-screen bg-gray-100">
  <div className="w-1/4 bg-white shadow-lg p-4 overflow-y-auto">
    ...
    <div className="space-y-4">
      {users.map((user) => (
        <div
          key={user.id}
          className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg shadow-sm hover:bg-gray-400 transition"
        >
  ...
  <div className="flex-1 bg-gray-50 p-6">
    <h2 className="text-lg font-bold text-gray-700 mb-4">Chat Messages</h2>
